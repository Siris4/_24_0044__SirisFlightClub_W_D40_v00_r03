...
import os
import requests
from flight_data_W_D40_v01_r03 import FlightData
...
class FlightSearch:
   ...
   ######################## END OF IATA CODE LOGIC ########################
    ...
    # define the endpoint Price and City search URL:
        ...
        #testing data temporarily:
        # print(f"FlightData(price): {flight_data.price}")
        # print(f"FlightData(origin_city): {flight_data.origin_city}")
        # print(f"FlightData(origin_airport): {flight_data.origin_airport}")
        # print(f"FlightData(destination_city): {flight_data.destination_city}")
        # print(f"FlightData(destination_airport): {flight_data.destination_airport}")
        # print(f"FlightData(out_date): {flight_data.out_date}")
        # print(f"FlightData(return_date): {flight_data.return_date}")
